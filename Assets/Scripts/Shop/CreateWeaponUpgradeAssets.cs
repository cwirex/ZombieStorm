...
namespace Assets.Scripts.Shop
{
    ...
    /// </summary>
    public class CreateWeaponUpgradeAssets
    {
        ...
        // For brevity, I'll create a simplified version for the remaining weapons
        
        private static void CreateShotgunUpgrades() { /* Implementation similar to above */ }
        private static void CreateM4Upgrades() { /* Implementation similar to above */ }
        private static void CreateAWPUpgrades() { /* Implementation similar to above */ }
        private static void CreateLMGUpgrades() { /* Implementation similar to above */ }
        private static void CreateFlamethrowerUpgrades() { /* Implementation similar to above */ }
        private static void CreateRPGUpgrades() { /* Implementation similar to above */ }
        ...
        {
            string weaponPath = AssetPath + weaponName + "/";
